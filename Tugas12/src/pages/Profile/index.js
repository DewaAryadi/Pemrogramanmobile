...
const Profile = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
                ...
                <Text style={{ fontSize: 16, color: 'grey', textAlign: 'center', marginHorizontal: 50 }}>Dewa Made Aryadi Mertha Sanjaya</Text>
                <Text style={{ fontSize: 16, color: 'grey', textAlign: 'center', marginHorizontal: 50 }}>1801010038</Text>
                <Text style={{ fontSize: 16, color: 'grey', textAlign: 'center', marginHorizontal: 50 }}>Sistem Informasi</Text>
